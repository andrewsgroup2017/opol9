...
function _initialize(draggable, geofence) {
  ...
  var mapOptions = {
    zoom: 10,
    center: new google.maps.LatLng(32.311524, -95.262412),
  ...
  if (geofence) {
    ...
    window.userPosition = {
      lon: customUserLocation.lng(),
      lat: customUserLocation.lat()
    };
...
function handleNoGeolocation(errorFlag) {
  ...
  var options = {
    map: map,
    position: new google.maps.LatLng(32.311524, -95.262412),
    content: content
  };
